...
class SingleDestinationView extends GetView<SingleDestinationController> {
  const SingleDestinationView({super.key});
  @override
  Widget build(BuildContext context) {
    final SingleDestinationController controller =
    ...
    return Scaffold(
      ...
      body: controller.obx(
        ...
        (dynamic state) => controller.packages.isEmpty
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          if (index == controller.packages.length) {
                            ...
                            for (final WishListModel wm
                              ...
                              if (wm.id == controller.packages[index].id) {
